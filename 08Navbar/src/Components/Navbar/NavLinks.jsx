      ...
      <div>
        <div className='px-3 text-left md:cursor-pointer group'>
          <h1 className='py-7 flex justify-between items-center md:pr-0 pr-5 group' 
            ...
            {link.name}
            <span className='text-xl md:hidden in-line'>
          ...
          {link.submenu && (
            <div>
              <div className='absolute top-20 hidden group-hover:md:block hover:md:block'>
                <div className='py-3'>
                  <div className='w-4 h-4 left-3 absolute mt-1 bg-red-300 rotate-45'>
                  </div>
                </div>
                <div className='bg-red-300 p-5 grid grid-cols-3 gap-10 '> 
                  {
              ...
              <div>
                <div>
                  <h1
                    ...
                    <span className='text-xl md:mt-1 md:ml-2 in-line'>
                  ...
                  <div className={`${subHeading === slinks.Head ? 'md:hidden' : 'hidden'}`}>
                      {slinks.sublink.map((slink)=>(
                        <li className='py-3 pl-14'>
                          <Link to={slink.link}
                          className='hover:text-primary'>{slink.name}</Link>
                        </li>
                      ))}
                  </div>
                </div>
